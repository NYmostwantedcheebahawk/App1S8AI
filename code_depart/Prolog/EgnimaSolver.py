...
class EnigmaSolver():
    def __init__(self):
        ...
        self.crystals = []
        self.three_crystals_prolog_kb = "consult('Prolog/3Cristals.pl')."
        self.four_crystals_prolog_kb  = "consult('Prolog/4Cristals.pl')."
        self.five_crystals_prolog_kb  = "consult('Prolog/5Cristals.pl')."
        self.six_crystals_prolog_kb   = "consult('Prolog/6Crystlas.pl')."
